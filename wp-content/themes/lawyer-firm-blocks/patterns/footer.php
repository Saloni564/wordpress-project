...
/**
 * Title: Footer
 * Slug: lawyer-firm-blocks/footer
 * Categories: lawyer-firm-blocks, footer
 */
?>
...
<div class="wp-block-columns"><!-- wp:column {"fontFamily":"inter"} -->
<div class="wp-block-column has-inter-font-family"><!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap"}} -->
...
<p class="has-text-align-left"><?php esc_html_e('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.','lawyer-firm-blocks'); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p><?php esc_html_e('example@example.com','lawyer-firm-blocks'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:social-links {"iconColor":"black","iconColorValue":"#000000","iconBackgroundColor":"primary","iconBackgroundColorValue":"#EFE72C","size":"has-normal-icon-size","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|30","left":"var:preset|spacing|30"}}},"className":"is-style-default"} -->
...
<!-- wp:column {"fontFamily":"inter"} -->
<div class="wp-block-column has-inter-font-family"><!-- wp:heading {"level":5,"style":{"typography":{"fontStyle":"normal","fontWeight":"600","letterSpacing":"1px"}},"textColor":"white","fontFamily":"inter"} -->
<h5 class="wp-block-heading has-white-color has-text-color has-inter-font-family" style="font-style:normal;font-weight:600;letter-spacing:1px"><?php esc_html_e('Recent Posts','lawyer-firm-blocks'); ?></h5>
<!-- /wp:heading -->
...
<p><?php esc_html_e('There is no posts to display','lawyer-firm-blocks'); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:column {"fontFamily":"inter"} -->
<div class="wp-block-column has-inter-font-family"><!-- wp:heading {"level":5,"style":{"typography":{"fontStyle":"normal","fontWeight":"600","letterSpacing":"1px"}},"textColor":"white","fontFamily":"inter"} -->
<h5 class="wp-block-heading has-white-color has-text-color has-inter-font-family" style="font-style:normal;font-weight:600;letter-spacing:1px"><?php esc_html_e('Quick Links','lawyer-firm-blocks'); ?></h5>
<!-- /wp:heading -->
...
<h5 class="wp-block-heading has-white-color has-text-color has-inter-font-family" style="font-style:normal;font-weight:600;letter-spacing:1px"><?php esc_html_e('Gallery','lawyer-firm-blocks'); ?></h5>
<!-- /wp:heading -->
...
<div class="wp-block-group alignwide"><!-- wp:group {"textColor":"black","className":"copyright-text","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"},"fontFamily":"inter"} -->
<div class="wp-block-group copyright-text has-black-color has-text-color has-inter-font-family"><!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|Background"}}}},"textColor":"Background"} -->
<p class="has-background-color has-text-color has-link-color"><a rel="noreferrer noopener" href="https://www.ovationthemes.com/products/free-lawyer-wordpress-theme/" target="_blank"><?php esc_html_e('Lawyer Firm Blocks WordPress Theme','lawyer-firm-blocks'); ?></a>.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|Background"}}}},"textColor":"Background"} -->
<p class="has-background-color has-text-color has-link-color"><?php esc_html_e('Proudly powered by','lawyer-firm-blocks'); ?> <a rel="noreferrer noopener" href="https://www.ovationthemes.com/" target="_blank"><?php esc_html_e('Ovation Themes','lawyer-firm-blocks'); ?></a> <?php esc_html_e('and','lawyer-firm-blocks'); ?> <a href="https://wordpress.org"><?php esc_html_e('WordPress','lawyer-firm-blocks'); ?></a>.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
