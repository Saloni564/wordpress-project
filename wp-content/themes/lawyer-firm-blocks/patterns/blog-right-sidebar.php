 ...
 * Slug: lawyer-firm-blocks/blog-right-sidebar
 * Categories: lawyer-firm-blocks, blog-right-sidebar
 */
?>
...
<div class="wp-block-column sidebar-col" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar","theme":"lawyer-firm-blocks","area":"uncategorized"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->