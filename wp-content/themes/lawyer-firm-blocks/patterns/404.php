 ...
 * Slug: lawyer-firm-blocks/not-found
 * Categories: lawyer-firm-blocks, not-found
 */
?>
...
<h4 class="has-text-align-center has-gigantic-font-size" style="letter-spacing:2px;line-height:1.2"><?php esc_html_e('Page not found!','lawyer-firm-blocks'); ?></h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php esc_html_e('Sorry, the page you are looking for does not exist or has been moved.','lawyer-firm-blocks'); ?></p>
<!-- /wp:paragraph -->

<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"},"style":{"spacing":{"margin":{"top":"60px"}}}} -->
<div class="wp-block-buttons" style="margin-top:60px"><!-- wp:button {"textColor":"heading","style":{"border":{"radius":"0px"},"elements":{"link":{"color":{"text":"var:preset|color|heading"}}}}} -->
<div class="wp-block-button"><a class="wp-block-button__link has-heading-color has-text-color has-link-color wp-element-button" href="/" style="border-radius:0px"><?php esc_html_e('Return Home','lawyer-firm-blocks'); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->