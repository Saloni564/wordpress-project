...
/**
 * Title: Archives
 * Slug: lawyer-firm-blocks/archive
 * Categories: lawyer-firm-blocks, archive
 */
?>

<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() . '/images/inner-banner.png'); ?>","id":19,"dimRatio":50,"minHeight":300,"isDark":false,"className":"inner-cover-img","layout":{"type":"constrained","contentSize":"90%"}} -->
...
<h3 class="wp-block-heading has-text-align-center"><?php esc_html_e('Sorry, no post exist...','lawyer-firm-blocks'); ?></h3>
<!-- /wp:heading -->
